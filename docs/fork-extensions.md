...
This checkout is based on upstream `v0.7.2` (`9400a49af670fdb5db4af58e73f8df98588dbea9`). Fork behavior is kept
...
compatibility gates were retained on the `v0.7.2` fork baseline and have a review date of
