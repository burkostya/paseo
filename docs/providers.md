...
Provider plan usage is normalized and cached by the daemon. The app calls `provider.usage.list.request` through React Query when the usage tooltip or Host Usage settings screen is shown.
