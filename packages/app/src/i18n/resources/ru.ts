...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        basePicker: {
          trigger: "относительно {{baseRef}}",
          accessibility: "Сравнить зафиксированные изменения с {{baseRef}}",
          placeholder: "Выберите базовую ветку",
          searchPlaceholder: "Фильтр веток...",
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "Обновите хост, чтобы настроить ссылки на задачи",
        sectionTitle: "Серверы задач",
        add: "Добавить",
        addTitle: "Добавить сервер задач",
        editTitle: "Изменить сервер задач",
        nameLabel: "Название",
        urlLabel: "Шаблон URL",
        urlHint: "Используйте {id} на месте ID задачи",
        prefixesLabel: "Префиксы ID",
        prefixesHint: "Один чувствительный к регистру префикс на строку; после него идёт номер",
        preview: "Предпросмотр",
        save: "Сохранить",
        remove: "Удалить",
        removeTitle: "Удалить сервер задач?",
        removeMessage: "Удалить «{{name}}»?",
        empty: "Серверы задач не настроены",
        editAccessibility: "Изменить сервер задач {{name}}",
        removeAccessibility: "Удалить сервер задач {{name}}",
        ambiguousHost: "Этот ID задачи соответствует нескольким хостам",
        errors: {
          nameRequired: "Укажите название",
          prefixRequired: "Укажите хотя бы один префикс",
          duplicatePrefix: "ID и префиксы должны быть уникальны в пределах хоста",
          missingPlaceholder: "Шаблон URL должен содержать {id}",
          invalidUrl: "Шаблон должен формировать корректный HTTP- или HTTPS-адрес",
        },
      },
      terminalProfiles: {
      ...
      agentProfiles: {
        ...
        identityUnsupported: "Обновите хост, чтобы отображать выбранный профиль агента.",
        emptyState:
