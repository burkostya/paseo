...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "Обновите host, чтобы настроить ссылки на задачи",
        ...
        ambiguousHost: "Этот ID задачи соответствует нескольким host",
        errors: {
          nameRequired: "Укажите название",
          prefixRequired: "Укажите хотя бы один префикс",
          duplicatePrefix: "ID и префиксы должны быть уникальны в пределах host",
