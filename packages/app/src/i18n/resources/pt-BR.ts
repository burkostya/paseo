...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        basePicker: {
          trigger: "vs {{baseRef}}",
          accessibility: "Comparar alterações com commit com {{baseRef}}",
          placeholder: "Selecionar branch base",
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "Atualize este host para configurar links de issues",
        sectionTitle: "Servidores de issues",
        add: "Adicionar",
        addTitle: "Adicionar servidor de issues",
        editTitle: "Editar servidor de issues",
        nameLabel: "Nome",
        urlLabel: "Modelo de URL",
        urlHint: "Use {id} no lugar do ID da issue",
        prefixesLabel: "Prefixos de ID",
        prefixesHint: "Um prefixo por linha, diferenciando maiúsculas; seguido por um número",
        preview: "Prévia",
        save: "Salvar",
        remove: "Remover",
        removeTitle: "Remover servidor de issues?",
        removeMessage: 'Remover "{{name}}"?',
        empty: "Nenhum servidor de issues configurado",
        editAccessibility: "Editar servidor de issues {{name}}",
        removeAccessibility: "Remover servidor de issues {{name}}",
        ambiguousHost: "Este ID corresponde a mais de um host",
        errors: {
          nameRequired: "O nome é obrigatório",
          prefixRequired: "É necessário pelo menos um prefixo",
          duplicatePrefix: "Cada ID e prefixo deve ser único neste host",
          missingPlaceholder: "O modelo de URL deve conter {id}",
          invalidUrl: "O modelo deve gerar uma URL HTTP ou HTTPS válida",
        },
      },
      terminalProfiles: {
