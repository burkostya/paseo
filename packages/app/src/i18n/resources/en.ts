export const en = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        basePicker: {
          trigger: "vs {{baseRef}}",
          accessibility: "Compare committed changes against {{baseRef}}",
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "Update this host to configure issue links",
        sectionTitle: "Issue servers",
        add: "Add",
        addTitle: "Add issue server",
        editTitle: "Edit issue server",
        nameLabel: "Name",
        urlLabel: "URL template",
        urlHint: "Use {id} where the issue ID belongs",
        prefixesLabel: "ID prefixes",
        prefixesHint: "One case-sensitive prefix per line; each is followed by a number",
        preview: "Preview",
        save: "Save",
        remove: "Remove",
        removeTitle: "Remove issue server?",
        removeMessage: 'Remove "{{name}}"?',
        empty: "No issue servers configured",
        editAccessibility: "Edit issue server {{name}}",
        removeAccessibility: "Remove issue server {{name}}",
        ambiguousHost: "This issue ID matches more than one host",
        errors: {
          nameRequired: "Name is required",
          prefixRequired: "At least one prefix is required",
          duplicatePrefix: "Each ID and prefix must be unique on this host",
          missingPlaceholder: "URL template must contain {id}",
          invalidUrl: "URL template must produce a valid HTTP or HTTPS URL",
        },
      },
      terminalProfiles: {
