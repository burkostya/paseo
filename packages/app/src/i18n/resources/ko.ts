...
export const ko: TranslationResources = {
  ...
  agentStream: {
    ...
    permission: {
      ...
      rejected: "거부됨",
      skipped: "건너뜀",
      planDisabledAfterMessages: "이 계획 이후에 대화가 계속되어 더 이상 승인할 수 없습니다.",
    },
  },
  agentPanel: {
    states: {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        basePicker: {
          trigger: "{{baseRef}} 기준",
          accessibility: "커밋된 변경 사항을 {{baseRef}}와 비교",
  ...
  providerUsageAlerts: {
    hostSummary: "{{provider}} {{window}} {{percentage}}% 사용됨",
    additional: "+{{count}}개 더 보기",
    openUsage: "{{host}}의 사용량 한도 열기",
  },
  review: {
    comment: {
      add: "리뷰 댓글 추가",
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "이슈 링크를 설정하려면 이 호스트를 업데이트하세요",
        sectionTitle: "이슈 서버",
        add: "추가",
        addTitle: "이슈 서버 추가",
        editTitle: "이슈 서버 편집",
        nameLabel: "이름",
        urlLabel: "URL 템플릿",
        urlHint: "이슈 ID 위치에 {id}를 사용하세요",
        prefixesLabel: "ID 접두사",
        prefixesHint: "줄마다 대소문자를 구분하는 접두사 하나를 입력하세요",
        preview: "미리보기",
        save: "저장",
        remove: "제거",
        removeTitle: "이슈 서버를 제거할까요?",
        removeMessage: '"{{name}}"을(를) 제거할까요?',
        empty: "설정된 이슈 서버가 없습니다",
        editAccessibility: "이슈 서버 {{name}} 편집",
        removeAccessibility: "이슈 서버 {{name}} 제거",
        ambiguousHost: "이 이슈 ID가 둘 이상의 호스트와 일치합니다",
        errors: {
          nameRequired: "이름을 입력하세요",
          prefixRequired: "접두사를 하나 이상 입력하세요",
          duplicatePrefix: "각 ID와 접두사는 이 호스트에서 고유해야 합니다",
          missingPlaceholder: "URL 템플릿에 {id}가 있어야 합니다",
          invalidUrl: "URL 템플릿은 유효한 HTTP 또는 HTTPS URL이어야 합니다",
        },
      },
      terminalProfiles: {
