...
export const ja: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        basePicker: {
          trigger: "対 {{baseRef}}",
          accessibility: "コミット済みの変更を {{baseRef}} と比較",
          placeholder: "ベースブランチを選択",
          searchPlaceholder: "ブランチを絞り込む...",
          empty: "ブランチが見つかりません",
          title: "ベースブランチ",
          default: "デフォルト",
        },
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "Issueリンクを設定するにはこのホストを更新してください",
        sectionTitle: "Issueサーバー",
        add: "追加",
        addTitle: "Issueサーバーを追加",
        editTitle: "Issueサーバーを編集",
        nameLabel: "名前",
        urlLabel: "URLテンプレート",
        urlHint: "Issue IDの位置に{id}を使用します",
        prefixesLabel: "IDプレフィックス",
        prefixesHint: "1行に1つ、大文字小文字を区別し、その後に数字が続きます",
        preview: "プレビュー",
        save: "保存",
        remove: "削除",
        removeTitle: "Issueサーバーを削除しますか？",
        removeMessage: "「{{name}}」を削除しますか？",
        empty: "Issueサーバーが設定されていません",
        editAccessibility: "Issueサーバー{{name}}を編集",
        removeAccessibility: "Issueサーバー{{name}}を削除",
        ambiguousHost: "このIssue IDは複数のホストに一致します",
        errors: {
          nameRequired: "名前は必須です",
          prefixRequired: "1つ以上のプレフィックスが必要です",
          duplicatePrefix: "このホストではIDとプレフィックスを一意にしてください",
          missingPlaceholder: "URLテンプレートには{id}が必要です",
          invalidUrl: "有効なHTTPまたはHTTPS URLになるテンプレートを指定してください",
        },
      },
      terminalProfiles: {
