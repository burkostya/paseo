...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        committed: "ملتزم",
        basePicker: {
          trigger: "مقابل {{baseRef}}",
          accessibility: "مقارنة التغييرات الملتزم بها مع {{baseRef}}",
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "حدّث هذا المضيف لإعداد روابط المهام",
        sectionTitle: "خوادم المهام",
        add: "إضافة",
        addTitle: "إضافة خادم مهام",
        editTitle: "تعديل خادم المهام",
        nameLabel: "الاسم",
        urlLabel: "قالب URL",
        urlHint: "استخدم {id} مكان معرّف المهمة",
        prefixesLabel: "بادئات المعرّف",
        prefixesHint: "بادئة واحدة حساسة لحالة الأحرف في كل سطر، يليها رقم",
        preview: "معاينة",
        save: "حفظ",
        remove: "إزالة",
        removeTitle: "إزالة خادم المهام؟",
        removeMessage: "إزالة «{{name}}»؟",
        empty: "لم يتم إعداد خوادم مهام",
        editAccessibility: "تعديل خادم المهام {{name}}",
        removeAccessibility: "إزالة خادم المهام {{name}}",
        ambiguousHost: "يتطابق معرّف المهمة هذا مع أكثر من مضيف",
        errors: {
          nameRequired: "الاسم مطلوب",
          prefixRequired: "مطلوب بادئة واحدة على الأقل",
          duplicatePrefix: "يجب أن يكون كل معرّف وبادئة فريدًا في هذا المضيف",
          missingPlaceholder: "يجب أن يحتوي قالب URL على {id}",
          invalidUrl: "يجب أن ينتج القالب عنوان HTTP أو HTTPS صالحًا",
        },
      },
      terminalProfiles: {
