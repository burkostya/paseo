...
export const es: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        basePicker: {
          trigger: "frente a {{baseRef}}",
          accessibility: "Comparar cambios confirmados con {{baseRef}}",
          placeholder: "Seleccionar rama base",
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "Actualiza este host para configurar enlaces de incidencias",
        sectionTitle: "Servidores de incidencias",
        add: "Añadir",
        addTitle: "Añadir servidor de incidencias",
        editTitle: "Editar servidor de incidencias",
        nameLabel: "Nombre",
        urlLabel: "Plantilla de URL",
        urlHint: "Usa {id} donde debe aparecer el ID",
        prefixesLabel: "Prefijos de ID",
        prefixesHint: "Un prefijo por línea, respetando mayúsculas; seguido de un número",
        preview: "Vista previa",
        save: "Guardar",
        remove: "Eliminar",
        removeTitle: "¿Eliminar servidor de incidencias?",
        removeMessage: '¿Eliminar "{{name}}"?',
        empty: "No hay servidores de incidencias configurados",
        editAccessibility: "Editar servidor de incidencias {{name}}",
        removeAccessibility: "Eliminar servidor de incidencias {{name}}",
        ambiguousHost: "Este ID coincide con más de un host",
        errors: {
          nameRequired: "El nombre es obligatorio",
          prefixRequired: "Se requiere al menos un prefijo",
          duplicatePrefix: "Cada ID y prefijo debe ser único en este host",
          missingPlaceholder: "La plantilla de URL debe contener {id}",
          invalidUrl: "La plantilla debe generar una URL HTTP o HTTPS válida",
        },
      },
      terminalProfiles: {
