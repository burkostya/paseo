...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    route: {
      ...
      recovery: {
        ...
        partialFailure: "部分嵌套 workspace 无法恢复（{{count}}）。",
      },
    },
    hoverCard: {
    ...
    git: {
      ...
      diff: {
        ...
        basePicker: {
          trigger: "对比 {{baseRef}}",
          accessibility: "将已 commit 的变更与 {{baseRef}} 比较",
          placeholder: "选择基础分支",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      hierarchy: {
        ...
        root: "项目根目录",
        search: "搜索父工作区...",
        noCandidates: "没有符合条件的父工作区",
        hostUpgrade: "请更新主机以管理工作区层级。",
        failed: "更新工作区层级失败",
        invalidDrop: "无法将该 workspace 放置在这里",
        collapse: "折叠工作区",
        expand: "展开工作区",
      },
      confirmations: {
        ...
        hideConfirm: "隐藏",
        archiveSubtreeTitle: "归档工作区树？",
        archiveSubtreeMessage: "归档「{{workspaceName}}」及其 {{descendantCount}} 个子工作区？",
        archiveSubtreeConfirm: "全部归档",
        cancel: "取消",
      },
      rename: {
        title: "重命名 workspace",
      ...
      toasts: {
        ...
        archivePartial: "有 {{failedCount}} 个工作区无法归档",
      },
    },
  },
  newWorkspace: {
  ...
  settings: {
    ...
    host: {
      ...
      issueTrackers: {
        updateRequired: "请更新此 Host 以配置任务链接",
        sectionTitle: "任务服务器",
        add: "添加",
        addTitle: "添加任务服务器",
        editTitle: "编辑任务服务器",
        nameLabel: "名称",
        urlLabel: "URL 模板",
        urlHint: "使用 {id} 表示任务 ID",
        prefixesLabel: "ID 前缀",
        prefixesHint: "每行一个区分大小写的前缀，后面跟数字",
        preview: "预览",
        save: "保存",
        remove: "删除",
        removeTitle: "删除任务服务器？",
        removeMessage: "删除“{{name}}”？",
        empty: "尚未配置任务服务器",
        editAccessibility: "编辑任务服务器 {{name}}",
        removeAccessibility: "删除任务服务器 {{name}}",
        ambiguousHost: "此任务 ID 与多个 Host 匹配",
        errors: {
          nameRequired: "名称为必填项",
          prefixRequired: "至少需要一个前缀",
          duplicatePrefix: "每个 ID 和前缀在此 Host 中必须唯一",
          missingPlaceholder: "URL 模板必须包含 {id}",
          invalidUrl: "模板必须生成有效的 HTTP 或 HTTPS URL",
        },
      },
      terminalProfiles: {
