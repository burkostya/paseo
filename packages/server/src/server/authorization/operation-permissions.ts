...
const INBOUND_PERMISSION = {
  ...
  "workspace.hierarchy.setParent.request": "workspace.manage",
  "workspace.hierarchy.inspectSubtree.request": "workspace.read",
  "workspace.hierarchy.archiveSubtree.request": "workspace.manage",
  "workspace.hierarchy.restoreSubtree.request": "workspace.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "workspace.hierarchy.setParent.response": "workspace.manage",
  "workspace.hierarchy.inspectSubtree.response": "workspace.read",
  "workspace.hierarchy.archiveSubtree.response": "workspace.manage",
  "workspace.hierarchy.restoreSubtree.response": "workspace.manage",
